...
const Viewdata = (props) => {
    const [data, setData] = useState({
        PatientUHID: "", signature: "", referralDate: null, firstName: "",
        fatherName: "", grandFatherName: "", age: "", birthDate: "", gender: "", bloodGroup: "", ward: "", bedNo: "", referringNo: "",
        Results: {
            resultWBC: "", resultRBC: "", resultHGB: "", resultHCT: "", mcvResult: "", mchResult: "", mchcResult: "", esrResult: "",
        ...
        }, priority: "", department: "", DoctorID: "", test: "Hematology"
    })

    useEffect(() => {

        axios.get(`http://localhost:4001/api/labRequest/hematology`)
                ...
                <div style={{ marginLeft: '220px' }}>
                    <div style={{ padding: '20px' }}>
                        ...
                        <div style={{ backgroundColor: "white", padding: "30px", clear: 'both' }}>
                            <ResultFill  data={data} updateInfo={updateStaffDatas} />
                        </div>
                    </div>
                </div>
            </div>
