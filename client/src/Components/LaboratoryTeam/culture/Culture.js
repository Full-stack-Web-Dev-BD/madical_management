...
const Culture = (props) => {
    ...
    useEffect(()=>{
        ...
        axios.get(`http://localhost:4001/api/labRequest/culture/${props.match.params.RequestID}`)
        .then(res=>{
    ...
    const handleSubmit=(e)=> {
        ...
        axios
        .put(`http://localhost:4001/api/labRequest/culture/${props.match.params.RequestID}`,{
